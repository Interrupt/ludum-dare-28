package com.interrupt.ludum.gfx;
 ...
 * </table>
 * </p> */
public class PlaneGroupStrategy implements GroupStrategy, Disposable {
	...
	public PlaneGroupStrategy (final Camera camera) {
		this(camera, new Comparator<Decal>() {
			@Override
			public int compare (Decal o1, Decal o2) {
				float dist1 = o1.getPosition().y - o1.getPosition().z * 0.5f;
				float dist2 = o2.getPosition().y - o2.getPosition().z * 0.5f;
				return (int)Math.signum(dist2 - dist1);
			}
		});
	}
	
	public PlaneGroupStrategy(Camera camera, Comparator<Decal> sorter) {
		this.camera = camera;
	...
	public void beforeGroups () {
		if(enableDepthTest) Gdx.gl.glEnable(GL10.GL_DEPTH_TEST);
		else Gdx.gl.glDisable(GL10.GL_DEPTH_TEST);
